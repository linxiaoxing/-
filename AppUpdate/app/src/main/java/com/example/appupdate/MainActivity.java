...
import com.example.appupdate.ui.JavaActivity;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DrawableUtil.setTextSolidTheme((Button) findViewById(R.id.btn_java), 2,
                60, 0xffedd0be);
        DrawableUtil.setTextSolidTheme((Button) findViewById(R.id.btn_kotlin), 2,
                60, 0xffff534d);
