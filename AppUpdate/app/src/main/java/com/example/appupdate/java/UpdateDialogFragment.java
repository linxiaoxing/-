package com.example.appupdate.java;
...
import com.example.appupdate.java.listener.ExceptionHandlerHelper;
import com.example.appupdate.java.listener.IUpdateDialogFragmentListener;
import com.example.appupdate.java.service.DownloadService;
import com.example.appupdate.java.utils.AppUpdateUtils;
import com.example.appupdate.java.utils.ColorUtil;
import com.example.appupdate.java.utils.DrawableUtil;
import com.example.appupdate.java.view.NumberProgressBar;
...
//            }
    ...
    private void installApp() {
        if (AppUpdateUtils.appIsDownloaded(mUpdateApp)) {
            AppUpdateUtils.installApp(getContext(), AppUpdateUtils.getAppFile(mUpdateApp));
            //安装完自杀
